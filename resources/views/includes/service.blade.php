<script>
    ...
    listAgama = {
        store: new DevExpress.data.CustomStore({
            ...
            loadMode: "raw",
            load: function() {
                return $.post(apiurl + "/list-agama"+'?_token=' + '{{ csrf_token() }}');
            }
        }),
        sort: "id"
    }
    ...
    listGender = {
        store: new DevExpress.data.CustomStore({
            ...
            loadMode: "raw",
            load: function() {
                return $.post(apiurl + "/list-gender"+'?_token=' + '{{ csrf_token() }}');
            }
        }),
        sort: "keterangan_gender"
    }
    ...
    listDepartemen = {
        store: new DevExpress.data.CustomStore({
            ...
            loadMode: "raw",
            load: function() {
                return $.post(apiurl + "/list-departemen"+'?_token=' + '{{ csrf_token() }}');
            }
        }),
        sort: "nama_departemen"
    }
    ...
    listKontraktor = {
        store: new DevExpress.data.CustomStore({
            ...
            loadMode: "raw",
            load: function() {
                return $.post(apiurl + "/list-kontraktor"+'?_token=' + '{{ csrf_token() }}');
            }
        }),
        sort: "nama_kontraktor"
    }
    ...
    listVaksin = {
        store: new DevExpress.data.CustomStore({
            ...
            loadMode: "raw",
            load: function() {
                return $.post(apiurl + "/list-vaksin"+'?_token=' + '{{ csrf_token() }}');
            }
        }),
        sort: "nama_vaksin"
    }
    ...
    listPekerja = {
        store: new DevExpress.data.CustomStore({
            ...
            load: function() {
                ...
                return $.post(apiurl + "/list-pekerja"+'?_token=' + '{{ csrf_token() }}', function(data){ var pekerja = data; return data});
            }
        }),
        sort: "no_nik"
    }
    ...
    listEstate = {
        store: new DevExpress.data.CustomStore({
            ...
            loadMode: "raw",
            load: function() {
                return $.post(apiurl + "/list-estate"+'?_token=' + '{{ csrf_token() }}');
            }
        }),
        sort: "nama_estate"
    }
